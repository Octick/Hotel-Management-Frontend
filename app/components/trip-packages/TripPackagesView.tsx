...
import { Bus, Clock, Edit2, Power, Trash2, Users } from "lucide-react";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        {packages.map((pkg) => {
          ...
          return (
            <div
              key={pkgId}
              className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-lg transition-shadow border border-black"
            >
              {/* ✅ Image Header */}
              ...
              <div className="p-4 md:p-6">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className={`text-xs font-medium px-2 md:px-3 py-1 rounded-full flex-shrink-0 ml-2 ${pkg.status === "Active"
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    className={`p-2 rounded-lg transition-colors ${pkg.status === "Active"
